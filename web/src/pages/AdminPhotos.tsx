...
export default function AdminPhotos() {
  ...
  return (
    <main className="p-4 max-w-7xl mx-auto">
      <div className="mb-6">
        <h1 className="font-heading text-3xl mb-4">Photo Management</h1>
        {!showUpload && (
          <button
            onClick={() => setShowUpload(true)}
            className="w-full md:w-auto bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700
              font-medium text-lg shadow-md flex items-center justify-center gap-2"
          >
