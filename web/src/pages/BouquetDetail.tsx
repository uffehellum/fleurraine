...
export default function BouquetDetail() {
  ...
  const handleApplePay = async () => {
    ...
    // TODO: Implement Stripe Apple Pay integration
    alert('Apple Pay integration coming soon! For now, please use Venmo.');
  };
    ...
    <main className="p-4 max-w-4xl mx-auto">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className="w-full bg-black text-white py-4 rounded-lg text-lg font-semibold hover:bg-gray-800 flex items-center justify-center gap-2"
        >
        ...
        <button
          onClick={handleVenmo}
          className="w-full bg-[#008CFF] text-white py-4 rounded-lg text-lg font-semibold hover:bg-[#0074D9] flex items-center justify-center gap-2"
        >
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
